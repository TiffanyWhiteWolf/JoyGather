...
export const activities: Activity[] = [
  {
    ...
    date: '06月30日', time: '18:30 - 21:00', location: '桥西历史文化街区', city: '杭州', district: '拱墅区', distance: 2.4,
  ...
  },
  {
    ...
    date: '07月02日', time: '09:00 - 14:30', location: '九溪公交站', city: '杭州', district: '西湖区', distance: 8.6,
  ...
  },
  {
    ...
    date: '07月04日', time: '19:00 - 22:30', location: '湖滨银泰 IN77', city: '杭州', district: '上城区', distance: 4.1,
  ...
  },
  {
    ...
    date: '07月05日', time: '07:30 - 10:00', location: '太子湾公园大草坪', city: '杭州', district: '西湖区', distance: 6.8,
  ...
  },
  {
    ...
    date: '07月06日', time: '14:00 - 16:00', location: '晓风书屋', city: '杭州', district: '滨江区', distance: 9.2,
  ...
  },
  {
    ...
    date: '07月08日', time: '13:30 - 16:30', location: '天目里社区中心', city: '杭州', district: '西湖区', distance: 5.3,
...
export const reviewTasks: ReviewTask[] = [
  { id: 'rv-001', type: '活动审核', targetId: 'act-pending-001', title: '千岛湖夜间桨板体验', submitter: '浪尖水上俱乐部', risk: '高', reason: '水上活动 / 预计 68 人 / AI 标记安全风险', submittedAt: '10分钟前', status: '待审核' },
  { id: 'rv-002', type: '商家认证', targetId: 'merchant-001', title: '流木咖啡（湖滨店）', submitter: '陈先生', risk: '低', reason: '营业执照与门店认证', submittedAt: '32分钟前', status: '待审核' },
  { id: 'rv-003', type: '举报处理', targetId: 'report-001', title: '夏夜酒吧交友派对', submitter: '用户举报 3 次', risk: '中', reason: '疑似宣传内容与实际活动不符', submittedAt: '1小时前', status: '待审核' },
  { id: 'rv-004', type: '活动审核', targetId: 'act-pending-002', title: '凌晨天文观测小队', submitter: '星空信号站', risk: '中', reason: '夜间活动 / 偏远地点', submittedAt: '2小时前', status: '待审核' },
]
