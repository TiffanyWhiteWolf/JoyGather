...
import { CalendarDays, Camera, CheckCircle2, ChevronRight, FileText, Heart, MapPin, QrCode, Settings, Star, Users } from 'lucide-vue-next'
...
>>>>>>> 46fadcfb1b87e0d20acf381bbe621290a6dcc49a
  ...
  <div v-if="currentUser" class="container profile-page">
    ...
    <section v-if="editing" class="edit-panel">
      ...
      <div class="form-grid">
        ...
        <label>生日<input v-model="profile.birthday" type="date" class="input" /></label>
