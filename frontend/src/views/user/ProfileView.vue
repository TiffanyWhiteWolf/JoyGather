...
async function saveProfile() {
  ...
  saving.value = true
  try {
    const updated = await apiPut<User>('/users/me', { ...profile, interests: profile.interests.split(/[、,，]/).map(item => item.trim()).filter(Boolean) })
